...
executor_cfg = dict(
    ...
    nodes=[
        ...
        dict(
            ...
            model_config='configs/hand/2d_kpt_sview_rgb_img/topdown_heatmap/coco_wholebody_hand/'
            'litehrnet_w18_coco_wholebody_hand_256x256.py',
            model_checkpoint='https://download.openmmlab.com/mmpose/hand/litehrnet/'
            'litehrnet_w18_coco_wholebody_hand_256x256-d6945e6a_20210908.pth',
            labels=['hand'],
            smooth=True,
